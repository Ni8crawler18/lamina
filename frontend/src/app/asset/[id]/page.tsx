      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          ...
          <div className="flex items-center gap-3 mt-2">
            ...
            <span className="font-mono text-xs text-muted-foreground">{asset.token_id as string || "pending"}</span>
            {auditLog?.topic_id && (
              <>
                <span className="text-muted-foreground/30">|</span>
                <span className="font-mono text-xs text-muted-foreground">HCS: {auditLog.topic_id}</span>
              </>
            )}
          </div>
        </div>
